...
const todos = [
  { id: 1, title: "Task 1", completed: false, description: "A Task" },
  { id: 2, title: "Task 2", completed: true, description: "Another Task" },
  { id: 3, title: "Task 3", completed: false, description: "A Third Task" },
  { id: 4, title: "Task 4", completed: true, description: "A Final Task" },
];
